...
public class MainActivity extends AppCompatActivity {
    ...
    private void initDemo(@IMProtocol int protocol){
        demo1 = new Client(localHost.getHostAddress(),client1UserId,protocol);
        demo2 = new Client(localHost.getHostAddress(),client2UserId, protocol);
